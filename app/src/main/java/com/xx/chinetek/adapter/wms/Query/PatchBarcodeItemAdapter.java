...
public class PatchBarcodeItemAdapter extends BaseAdapter {
    private Context           context; // 运行上下文
    private List<BarCodeInfo> stockInfoModels; // 信息集合
    ...
    public PatchBarcodeItemAdapter(Context context, List<BarCodeInfo> stockInfoModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BarCodeInfo info=stockInfoModels.get(selectID);
        listItemView.txtMaterialNo.setText("条码:"+info.getSerialNo());
//        listItemView.txtAreaNo.setText("库位："+info.getarea());
//        listItemView.txtEAN.setText("EAN："+info.getEAN());
//        listItemView.txtMaterialDec.setText(info.getMaterialDesc());
//        listItemView.txtQty.setText("数量："+info.getQty()+"");
//        listItemView.txtBatchNo.setText(info.getMaterialNo());
//        listItemView.txtCompany.setText("据："+info.getStrongHoldName());
//        listItemView.txtQCStatus.setText(info.getStrStatus());
