...
public class DLInScan extends BaseActivity {
    ...
    private boolean edtRecScanBarcode(View v, int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_UP)// 如果为Enter键
        {
            ...
            LogUtil.WriteLog(DLInScan.class, TAG_GetT_PalletDetailByBarCodeADF, code);
...
//                        }
                    ...
                    LogUtil.WriteLog(DLInScan.class, TAG_SaveT_InStockDetailADF, ModelJson);
    ...
    void GetReceiptDetail(final Receipt_Model receiptModel) {
            ...
            LogUtil.WriteLog(DLInScan.class, TAG_GetT_InStockDetailListByHeaderIDADF, para);
    ...
    void AnalysisGetT_InStockDetailListJson(String result) {
        LogUtil.WriteLog(DLInScan.class, TAG_GetT_InStockDetailListByHeaderIDADF, result);
        try {
    ...
    void AnalysisGetT_PalletDetailByNoADF(String result) {
        LogUtil.WriteLog(DLInScan.class, TAG_GetT_PalletDetailByBarCodeADF, result);
        try {
...
//                        barCodeInfos.remove(barCodeInfos.get(i));
    ...
    void AnalysisSaveT_InStockDetailADFJson(String result) {
        try {
            LogUtil.WriteLog(DLInScan.class, TAG_SaveT_InStockDetailADF, result);
